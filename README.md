UTS (3D MINI GAME FREADING FEENZY)
...
b. Konsep Grafika yang DigunakanProgram ini tidak menggunakan gambar (sprite) untuk objek utamanya, melainkan menggunakan    konsep Grafika Vektor Berbasis Piksel:
  ...
  *Rendering Loop: Proses menghapus layar, menghitung posisi baru, dan menggambar ulang objek secara terus-menerus (60  b    kali per detik).
...
d. Cara Menjalankan ProgramUntuk menjalankan program ini, ikuti langkah-langkah berikut:
  ...
  *Menyiapkan Asset (Opsional): Jika Anda memiliki gambar latar belakang, beri nama background1.jpg di folder yang 
   sama.Jika tidak ada, program akan otomatis menggunakan latar belakang warna biru laut.
